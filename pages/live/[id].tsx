      ...
      <div>
        ...
        <div className="mt-10 pb-16 h-[50vh] overflow-y-scroll px-4 space-y-4">
          <div className="flex items-start space-x-2">
            ...
            <div className="w-1/2 text-sm p-2 border border-gray-300 rounded-md bg-gray-300">
              <p>Hi how much are you selling them for?</p>
            </div>
          </div>
          <div className="flex flex-row-reverse items-start space-x-2 space-x-reverse">
            <div className="w-8 h-8 rounded-full bg-slate-400" />
            <div className="w-1/2 text-sm p-2 border rounded-md bg-orange-500 text-white">
              <p>I want ￦20,000</p>
            </div>
          </div>
          <div className="flex items-start space-x-2">
        ...
        <div className="fixed py-2 bg-white  bottom-0 inset-x-0">
          <div className="flex relative max-w-lg items-center w-full mx-auto">
            <input
              type="text"
